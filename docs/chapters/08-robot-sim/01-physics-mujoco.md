...
*   过去传统的商业物理引擎往往倾向于为了浮夸的视觉效果而牺牲动力学计算的精度。而基于严密理论推演的 [Todorov et al., 2012] 研究所提出的 MuJoCo，无可辩驳地确立了广义坐标法（Generalized Coordinates）与凸优化接触求解相结合的数学新标准，使其成为现代具身智能与强化学习底层建设的绝对基石。
