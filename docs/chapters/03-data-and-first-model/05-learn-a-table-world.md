...
[1.8](/chapters/01-why-world-models/01-invent-a-world-model) 的转移表是你写的。现在拿走那张表。一段经历怎样保存、怎样取样、怎样切分，再怎样变成 \(\hat P(s'|s,a)\)，必须亲手接起来。跑完你会对「第一台世界模型」四个字有完全不同的理解——它甚至可以没有梯度。
