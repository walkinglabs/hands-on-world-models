...
>
> 本章前三篇短文围绕同一份数据和同一个小环境展开，最终在 [3.5 动手：表格世界模型的从零开始实现](/chapters/03-data-and-first-model/05-learn-a-table-world) 中完成全流程串联。完成第 1–3 章后即可掌握世界模型共用的数据语言，进入后续五条具体路线。
