...
>
> 动手实验：[8.6 动手：占用网格预测的从零开始实现](/chapters/09-spatial-worlds/06-occupancy-scratch)；本章收尾是 [8.7 动手：驾驶场景下的四维世界模型](/chapters/09-spatial-worlds/07-four-d-driving-concise)。
