...
1. [为什么改成预测特征](./04-01-feature-prediction.md)
2. [Mask、EMA 与表示坍缩](./04-02-mask-ema-collapse.md)
3. [从图片 JEPA 到视频 JEPA](./04-03-video-jepa.md)
4. [Action-JEPA：让特征未来听从动作](./04-04-action-jepa.md)
