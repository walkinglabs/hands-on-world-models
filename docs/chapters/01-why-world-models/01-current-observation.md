...
>
> 本章沿着由浅入深的逻辑递进主线展开：从 1.1 观察、状态与历史、1.2 动作条件预测，到 1.3 多步推演与规划、1.4 从经历学习动力学、1.5 经典世界模型，最终在 [1.6 动手：从零重新发明世界模型](/chapters/01-why-world-models/06-invent-a-world-model) 中使用纯 Python 手工实现最小可运行闭环。
