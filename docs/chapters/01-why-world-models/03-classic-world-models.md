...
理论与架构的推演至此全部打通。下一篇 [1.4 动手：在想象中驾驶](/chapters/01-why-world-models/04-imagine-driving) 不写代码：先玩一台会猜下一步的表格世界模型，再看 2018 年那台在梦里学会开车的系统。手写九格转移表放到 [3.5](/chapters/03-data-and-first-model/05-learn-a-table-world)。
