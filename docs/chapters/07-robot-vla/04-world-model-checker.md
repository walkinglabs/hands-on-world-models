...
本章动手实验见 [D1：视觉-语言-动作模型（VLA）](/chapters/07-robot-vla/05-robot-vla) 与 [D2：动作后果检查（世界模型检查器）](/chapters/07-robot-vla/05-robot-vla)，更多内容见 [D1–E2 机器人与空间实验](/chapters/07-robot-vla/05-robot-vla)。
