...
>
> **前置知识**：8.1–8.4 已经讲过基线、反事实、硬件证据和失败分析。这一节把它们接到可运行的函数上。具体单元格在 [8.6 实验页](/chapters/08-evaluate-and-invent/06-test-a-world-model)；本页写清「为什么这样问、怎样才算过」。
...
| 内容 | 本页 8.5 | [8.6](/chapters/08-evaluate-and-invent/06-test-a-world-model) |
| ---- | -------- | -------------- |
