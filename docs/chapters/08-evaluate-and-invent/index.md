...
5. [8.5　审问世界模型](./08-05-interrogate-world-model.md)：把六项审问写成带公式和真实数字的判据
6. [8.6　动手：审问一台世界模型](./08-06-test-a-world-model.md)：对解析玩具和 PA1 模型做基线、多步、反事实与 OOD 检查
7. [8.7　动手：实现自己的世界模型](./08-07-next-model-proposal.md)：基于失败分析提出最小改进，实现代码并通过公平对照实验验证假设
