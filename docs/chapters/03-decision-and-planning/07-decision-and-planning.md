...
> **前置知识**：你已经读过 3.1–3.4，知道 RSSM 的 prior/posterior、Dreamer 的 imagination 循环、Actor-Critic 的 TD-λ。最好刚跑完 [3.6 动手复现 World Models](/chapters/03-decision-and-planning/06-reproduce-world-models)。这一节把它们真跑一遍。
