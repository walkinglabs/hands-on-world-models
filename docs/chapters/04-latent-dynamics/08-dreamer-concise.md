...
> **前置知识**：你已经读过 4.1–4.5，知道 RSSM 的 prior/posterior、Dreamer 的 imagination 循环、Actor-Critic 的 TD-λ。最好刚跑完 [4.6 动手：World Models 的复现](/chapters/04-latent-dynamics/07-rssm-scratch)。这一节把它们真跑一遍。
