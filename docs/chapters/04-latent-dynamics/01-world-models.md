...
<img src="/figures/04-latent-dynamics/latex/01-world-models/chapter-overview.png" alt="第 4 章学习路线：从 World Models 到潜空间动力学" width="100%">

_第 4 章学习路线：从视觉—记忆—控制解耦，逐步走向隐空间规划、梦境学习与价值等价。_
