...
到这里，决策路线已经串成一条线：潜在状态、RSSM、PlaNet/CEM、TD-MPC、Dreamer、MuZero。动手把这套接口跑通，见 [4.7 动手：Dreamer 的简化实现](/chapters/04-decision-and-planning/07-decision-and-planning)。
