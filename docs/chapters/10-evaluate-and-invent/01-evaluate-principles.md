...
<img src="/figures/10-evaluate-and-invent/latex/01-evaluate-principles/chapter-overview.png" alt="第 10 章学习路线：从评估原则到下一代世界模型设计" width="100%">

_第 10 章学习路线：从科学指标与系统基准出发，通过失效归因和可证伪改进，最终走向新模型设计。_
