...
>
> 👉 本章实验：[从图像到空间（相机几何、BEV、NeRF）](/chapters/07-spatial-worlds/06-spatial-world)（E1）、[四维世界（4D）](/chapters/07-spatial-worlds/06-spatial-world)（E2a，与 E2b 二选一）、[驾驶世界模型（未来占用预测）](/chapters/07-spatial-worlds/06-spatial-world)（E2b，与 E2a 二选一）；课程作业 [PA1-E：3D/4D 或驾驶二选一](/assignments/pa1-e)
