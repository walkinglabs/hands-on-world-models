...
> **前置知识**：你已经读过 8.1–8.6，知道针孔相机、深度反投影、BEV Occupancy。最好刚跑完 [3.5 动手：表格世界模型的从零开始实现](/chapters/03-data-and-first-model/05-learn-a-table-world)。这一节把几何真算一遍。
...
完成后进入 [8.7 动手：驾驶场景下的四维世界模型](/chapters/08-spatial-worlds/07-four-d-driving)。
