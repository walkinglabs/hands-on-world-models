...
>
> 核心实验：[9.2 动手：世界模型的系统评测](/chapters/09-evaluate-and-invent/02-systematic-evaluation) 与 [9.3 动手：从失效到下一台世界模型](/chapters/09-evaluate-and-invent/03-failure-to-next-model)。
