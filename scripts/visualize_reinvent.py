...
if __name__ == '__main__':
    ...
    visualize_greedy_vs_planned(output_dir / 'greedy-vs-planned.png')
    visualize_mpc_process(output_dir / 'mpc-process.png')
    visualize_learning_from_data(output_dir / 'learning-from-data.png')
