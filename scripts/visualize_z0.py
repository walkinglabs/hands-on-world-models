...
if __name__ == "__main__":
    ...
    visualize_interrogation(output_dir / "z0-interrogation.png")
    visualize_toy_world(output_dir / "z0-toy-world.png")
    visualize_horizon_errors(output_dir / "z0-horizon-errors.png")
    visualize_horizon_process(output_dir / "z0-horizon-process.png")
    visualize_counterfactual(output_dir / "z0-counterfactual.png")
    visualize_ood(output_dir / "z0-ood.png")
    visualize_calibration(output_dir / "z0-calibration.png")
    visualize_planner(output_dir / "z0-planner.png")
    visualize_manifest(output_dir / "z0-manifest.png")
