...
def pa1e_unproject():
    ...
    for line in lines:
        ...
        y += 40
    save(canvas, "pa1e-unproject.png")
...
def pa1e_occupancy():
    ...
    save(canvas, "pa1e-occupancy.png")
