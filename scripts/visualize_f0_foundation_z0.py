#!/usr/bin/env python3
"""
为 f0, foundations, z0 生成真实可视化，替代 AI 生成的图片。
...
def visualize_interrogation(output_path):
    ...
    draw.text((pad, 8), "Z0: 审问世界模型——六项测试（真实 hwm.evaluation 输出）", fill='black', font=try_load_font(15))
...
if __name__ == '__main__':
    ...
    visualize_nine_grid(out_dir / 'f0-nine-grid.png')
    visualize_foundations(out_dir / 'f1-foundations.png')
    visualize_interrogation(out_dir / 'z0-interrogation.png')
